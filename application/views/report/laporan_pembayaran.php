...
<h3 style="font-size: 12px">REKAPITULASI DATA PELANGGAN AIR BERSIH PAMDES BOJONG PERIODE 
<center><p>Dari tanggal : <?php echo $_POST['tgl1']." s/d ".$_POST['tgl2']; ?></p></center></h3>
</center>
...
<table style="font-size: 12px" class="table table-responsive table-bordered table-striped" border="2">
	...
	<tr>
		<td colspan="7" align='center'><strong>JUMLAH</strong></td>
